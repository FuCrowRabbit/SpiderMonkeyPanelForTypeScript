 ...
 *
 * @param {PlaybackOrder} new_order_index
 *     - 0 Default<br>
 ...
 *     - 6 Shuffle (folders)
 */
declare function on_playback_order_changed(new_order_index: PlaybackOrder): void;
...
/**
 * @param {QueueType} origin
 *     - 0 User added<br>
 *     - 1 User removed<br>
 *     - 2 Playback advance
 */
declare function on_playback_queue_changed(origin: QueueType): void;
 ...
 *
 */
declare function on_playback_starting(cmd: TrackCommand, is_paused: boolean): void;
 ...
 *     - 3 Fb2k is shutting down<br>
 */
declare function on_playback_stop(reason: StopReason): void;
 ...
 *
 * @param {ReplaygainMode} new_mode
 *     - 0 None<br>
 *     - 1 Track<br>
 *     - 2 Album<br>
 *     - 3 Track/Album by Playback Order
 */
declare function on_replaygain_mode_changed(new_mode: ReplaygainMode): void;
