...
declare enum ReplaygainMode {
    ...
    Track = 1,
    Album = 2,
    PlaybackOrder = 3, // only available in foobar2000 v1.3.8 and later
}

declare enum GetSelectionType {
    undefined = 0, // no item
...
declare enum RunContextCommandFlags {
    default = 0, // depends on whether SHIFT key is pressed, flag_view_reduced or flag_view_full is selected
    flag_view_reduced = 4,
    flag_view_full = 8, // This can be useful if you need to run context commands the user may have hidden using File>Preferences>Display>Context Menu
}
...
declare enum UIModuleType {
    ColumnsUI = 0,
    DefaultUI = 1,
}

declare enum OrderByFormat {
    ascending = 0,
}
...
declare let fb: {
     ...
     * @param {RunContextCommandFlags=} [flags=0]
     ...
     */
    RunContextCommand: (command: string, flags?: RunContextCommandFlags) => boolean;
    /**
...
declare const window: {
     ...
     * @readonly
     */
    readonly InstanceType: UIModuleType;
    /**
...
declare class FbMetadbHandleList {
     ...
     * @param {OrderByFormat} direction > 0 - ascending.
     *
     * @example
     * let handle_list = fb.GetLibraryItems();
     ...
     */
    OrderByFormat: (tfo: FbTitleFormat, direction: OrderByFormat) => void; // (void)
